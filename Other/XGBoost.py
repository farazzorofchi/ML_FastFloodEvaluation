...
parameters = {'Predictor_xgboost__booster':['gbtree'], 'Predictor_xgboost__max_depth':[13,14,15], 'Predictor_xgboost__lambda':[0.01,0.1] }
...
joblib.dump(XGBoost_model_grid.best_estimator_, 'str_model_XGBoost_best_params.pkl')
