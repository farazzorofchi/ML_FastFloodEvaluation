...
mlp_model = Pipeline([('ohe', OHE_final),
                            ('mlp', MLPRegressor())
                            ])

parameters = {'mlp__hidden_layer_sizes':[(50,80,70,60,50,40,30,20,10,), (50,80,75,70,65,60,55,50,45,40,35,30,25,20,15,10,), (50,80,75,70,65,60,55,50,45,40,35,30,35,40,45,50,)], 'mlp__alpha':[0.001, 0.0001]}
